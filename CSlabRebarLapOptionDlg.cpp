// CSlabRebarLapOptionDlg.cpp: 实现文件
//


#include "_USTATION.h"
#include "CSlabRebarLapOptionDlg.h"
...
IMPLEMENT_DYNAMIC(CSlabRebarLapOptionDlg, CDialogEx)

CSlabRebarLapOptionDlg::CSlabRebarLapOptionDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_SlabRebar_LapOption, pParent)
{

}

CSlabRebarLapOptionDlg::~CSlabRebarLapOptionDlg()
{
}

void CSlabRebarLapOptionDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_S_LIST_LapOption, m_ListLapOption);
}

void CSlabRebarLapOptionDlg::InitUIData()
{
	// TODO:  在此添加额外的初始化
	LONG lStyle;
	...
	//在列表控件中插入列
	m_ListLapOption.InsertColumn(0, _T("层"), (int)(width / 7 * 0.75), ListCtrlEx::Normal, LVCFMT_CENTER, ListCtrlEx::SortByDigit);
	m_ListLapOption.InsertColumn(1, _T("连接方式"), (int)(width / 7 * 0.75), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_ListLapOption.InsertColumn(2, _T("搭接长度"), (int)(width / 7 * 1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_ListLapOption.InsertColumn(3, _T("库存长度"), (int)(width / 7 * 1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_ListLapOption.InsertColumn(4, _T("加工长度"), (int)(width / 7 * 1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	m_ListLapOption.InsertColumn(5, _T("是否交错"), (int)(width / 7 * 0.75), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
...
void CSlabRebarLapOptionDlg::SetListDefaultData()
{
...
void CSlabRebarLapOptionDlg::UpdateLapOptionList()
{
...
BEGIN_MESSAGE_MAP(CSlabRebarLapOptionDlg, CDialogEx)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_S_LIST_LapOption, &CSlabRebarLapOptionDlg::OnLvnItemchangedListLapoption)
END_MESSAGE_MAP()
...
BOOL CSlabRebarLapOptionDlg::OnInitDialog()
{
...
void CSlabRebarLapOptionDlg::OnLvnItemchangedListLapoption(NMHDR *pNMHDR, LRESULT *pResult)
{
