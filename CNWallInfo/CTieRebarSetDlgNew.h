...
class CTieRebarSetDlgNew : public CDialogEx
{
	DECLARE_DYNAMIC(CTieRebarSetDlgNew)

public:
	CTieRebarSetDlgNew(CWnd* pParent = nullptr);   // 标准构造函数
	virtual ~CTieRebarSetDlgNew();
...
// 对话框数据
	...
	enum { IDD = IDD_DIALOG_CNWallRebar_TieRebarSet };
#endif
