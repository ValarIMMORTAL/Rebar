...
#include "_USTATION.h"
#include "CWallRebarLapOptionDlgNew.h"
...
IMPLEMENT_DYNAMIC(CWallRebarLapOptionDlgNew, CDialogEx)

CWallRebarLapOptionDlgNew::CWallRebarLapOptionDlgNew(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_CNWallRebar_LapOption, pParent)
{

}

CWallRebarLapOptionDlgNew::~CWallRebarLapOptionDlgNew()
{
}

void CWallRebarLapOptionDlgNew::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_LIST_LapOption, m_ListLapOption);
}

void CWallRebarLapOptionDlgNew::InitUIData()
{
	// TODO:  在此添加额外的初始化
	LONG lStyle;
...
void CWallRebarLapOptionDlgNew::SetListDefaultData()
{
...
void CWallRebarLapOptionDlgNew::UpdateLapOptionList()
{
...
BEGIN_MESSAGE_MAP(CWallRebarLapOptionDlgNew, CDialogEx)
END_MESSAGE_MAP()
...
BOOL CWallRebarLapOptionDlgNew::OnInitDialog()
{
