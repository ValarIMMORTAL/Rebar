...
IMPLEMENT_DYNAMIC(CACCDataSetDlgNew, CDialogEx)

CACCDataSetDlgNew::CACCDataSetDlgNew(ElementHandleCR eh , const ACCConcrete &concrete, double offset,CWnd * pParent)
	: CDialogEx(IDD_DIALOG_CNACC_INFO, pParent), m_eh(eh), m_concrete(concrete), m_offset(offset), m_anchoringMethod(0),m_L0(0.0),m_La(0.0),m_IsReverse(0), m_IsCut(0)
{
}

CACCDataSetDlgNew::~CACCDataSetDlgNew()
{
}

void CACCDataSetDlgNew::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CACCDataSetDlgNew, CDialogEx)
	ON_BN_CLICKED(IDOK, &CACCDataSetDlgNew::OnBnClickedOk)
END_MESSAGE_MAP()
...
BOOL CACCDataSetDlgNew::OnInitDialog()
{
...
void CACCDataSetDlgNew::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strCover1, strCover2, strCover3, strOffset;
