...
class CACCDataSetDlgNew : public CDialogEx
{
	DECLARE_DYNAMIC(CACCDataSetDlgNew)

public:
//	CACCDataSetDlg(CWnd* pParent = nullptr);   // 标准构造函数
	CACCDataSetDlgNew(ElementHandleCR eeh, const ACCConcrete &concrete,double offset,CWnd* pParent = nullptr);
	virtual ~CACCDataSetDlgNew();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_CNACC_INFO };
#endif
