...
class CGWallRebarDlgNew : public CDialogEx
{
	DECLARE_DYNAMIC(CGWallRebarDlgNew)

public:
	CGWallRebarDlgNew(ElementHandleCR eh,CWnd* pParent = nullptr);   // 标准构造函数
	virtual ~CGWallRebarDlgNew();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_CNGwall };
#endif
	void InitUIData();
