...
*	Date:			2021/04/21
	Version:		V1.0
*	Description:	PITACCRebarAssemblyNew
*	History:
*	1. Date:		2021/04/21
*	Author:			LiuXiang
...
namespace PIT
{
	class ACCRebarAssemblyNew : public PITRebarAssembly
	{
	public:
		enum ComponentType
		{
	...
	public:
		...
		ACCRebarAssemblyNew(ElementId id = 0, DgnModelRefP modelRef = NULL) 
...
//		void InitRebarSetId();
	...
	class ACCWallRebarAssemblyNew : public ACCRebarAssemblyNew
	{
	public:
		ACCWallRebarAssemblyNew(ElementId id = 0, DgnModelRefP modelRef = NULL);
		virtual ~ACCWallRebarAssemblyNew() 
		{
...
//		virtual void	CalculateTransform(vector<CVector3D> &vTransform, DgnModelRefP modelRef) {}
	...
	class ACCSTWallRebarAssemblyNew : public ACCWallRebarAssemblyNew
	{
	...
	public:
		...
		BE_DECLARE_VMS(ACCSTWallRebarAssemblyNew, RebarAssembly)

	public:
		ACCSTWallRebarAssemblyNew(ElementId id = 0, DgnModelRefP modelRef = NULL) :
			ACCWallRebarAssemblyNew(id, modelRef)
		{
