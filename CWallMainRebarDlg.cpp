...
CWallMainRebarDlg * g_wallMainDlg = nullptr;

// CWallMainRebar 对话框

IMPLEMENT_DYNAMIC(CWallMainRebarDlg, CDialogEx)

CWallMainRebarDlg::CWallMainRebarDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_WallRebar_MainRebar, pParent), m_assodlg(NULL)
{
...
CWallMainRebarDlg::~CWallMainRebarDlg()
{
...
void CWallMainRebarDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_STATIC1, m_staticTxt1);
	DDX_Control(pDX, IDC_STATIC2, m_staticTxt2);
	DDX_Control(pDX, IDC_STATIC3, m_staticTxt3);
}


BEGIN_MESSAGE_MAP(CWallMainRebarDlg, CDialogEx)
	ON_EN_KILLFOCUS(IDC_EDIT1, &CWallMainRebarDlg::OnEnKillfocusEdit1)
	ON_EN_KILLFOCUS(IDC_EDIT2, &CWallMainRebarDlg::OnEnKillfocusEdit2)
	ON_EN_KILLFOCUS(IDC_EDIT3, &CWallMainRebarDlg::OnEnKillfocusEdit3)
	ON_EN_KILLFOCUS(IDC_EDIT4, &CWallMainRebarDlg::OnEnKillfocusEdit4)
	ON_MESSAGE(WM_UPDATELIST, &CWallMainRebarDlg::OnComboBoxDataChange)
	ON_BN_CLICKED(IDC_BUTTON1, &CWallMainRebarDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_HOLE_CHECK, &CWallMainRebarDlg::OnBnClickedHoleCheck)
	ON_EN_KILLFOCUS(IDC_MHOLESIZE_EDIT, &CWallMainRebarDlg::OnEnKillfocusMholesizeEdit)
	ON_BN_CLICKED(IDC_BUTTON2, &CWallMainRebarDlg::OnBnClickedButton2)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CWallMainRebarDlg::OnCbnSelchangeCombo1)
	ON_BN_CLICKED(IDC_BUTTON3, &CWallMainRebarDlg::OnBnClickedButton3)
	ON_BN_CLICKED(IDC_BUTTON_BreakEllipseWall, &CWallMainRebarDlg::OnBnClickedButtonBreakellipsewall)
	//ON_BN_CLICKED(IDC_SaveData, &CWallMainRebarDlg::OnBnClickedSavedata)
	ON_BN_CLICKED(IDC_RebarTemplate, &CWallMainRebarDlg::OnBnClickedRebartemplate)
	ON_BN_CLICKED(IDC_UpdataDlg, &CWallMainRebarDlg::OnBnClickedUpdatadlg)
END_MESSAGE_MAP()


// CWallMainRebar 消息处理程序

void CWallMainRebarDlg::InitUIData()
{
	...
	if (m_isFloor)
	{
		...
		m_listMainRebar.InsertColumn(1, _T("方向"), (int)(width / 11.0), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(2, _T("直径"), (int)(width / 11.0), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(3, _T("类型"), (int)(width / 11.0*1.25), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		if (g_wallRebarInfo.concrete.m_SlabRebarMethod == 2)
		{
			m_listMainRebar.InsertColumn(4, _T("环向间距/径向角度"), (int)(width / 11.0 * 2), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		}
		else
		{
			m_listMainRebar.InsertColumn(4, _T("间距"), (int)(width / 11.0), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		}
		m_listMainRebar.InsertColumn(5, _T("起点偏移"), (int)(width / 11.0*1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(6, _T("终点偏移"), (int)(width / 11.0*1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(7, _T("与前层间距"), (int)(width / 11.0), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(8, _T("位置"), (int)(width / 11.0), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		//m_listMainRebar.InsertColumn(9, _T("颜色"), (int)(width / 11*0.95), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(9, _T("线形"), (int)(width / 11 * 0.8), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(10, _T("线宽"), (int)(width / 11 * 0.8), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
	...
	else if (m_isWall)
	{
		...
		m_listMainRebar.InsertColumn(3, _T("类型"), (int)(width / 8.0*1.25), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(4, _T("间距"), (int)(width / 8.0*1.25), ListCtrlEx::EditBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(5, _T("位置"), (int)(width / 8.0*1.25), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		//m_listMainRebar.InsertColumn(9, _T("颜色"), (int)(width / 8*0.95), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(6, _T("线形"), (int)(width / 8 * 0.8), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
		m_listMainRebar.InsertColumn(7, _T("线宽"), (int)(width / 8 * 0.8), ListCtrlEx::ComboBox, LVCFMT_CENTER, ListCtrlEx::SortByString);
...
//void CWallMainRebarDlg::SetListDefaultData()
//{
...
void CWallMainRebarDlg::getWallSetInfo(WallSetInfo& wallsetinfo)
{
...
void CWallMainRebarDlg::Set_m_DlgData()
{
	CString strpostive;
...
void CWallMainRebarDlg::Save_templateName()
{
...
void CWallMainRebarDlg::GetAllRebarData(std::vector<PIT::ConcreteRebar> &vecListData)
{
	if (m_isWall)
...
void CWallMainRebarDlg::GetAllWallRebarData(std::vector<PIT::ConcreteRebar> &vecListData)
{
	m_listMainRebar.SetisWall();
	m_listMainRebar.GetAllRebarData(vecListData);
...
bool  CWallMainRebarDlg::ParsingLineDir(EditElementHandleR ehLine)
{
...
bool  CWallMainRebarDlg::ParsingArcLineDir(EditElementHandleR ehLine)
{
...
void CWallMainRebarDlg::UpdateRebarList()
{
	...
	if (m_isFloor)
	{
		for (int i = 0; i < g_wallRebarInfo.concrete.rebarLevelNum; ++i)
		{
			...
			for (int j = 1; j <= nSubCnt; ++j)
			{
				...
				case 1:
				{
					ListCtrlEx::CStrList strlist = g_listFloorRebarDir;
...
void CWallMainRebarDlg::GetConcreteData(PIT::Concrete& concreteData)
{
...
BOOL CWallMainRebarDlg::OnInitDialog()
{
	CDialogEx::OnInitDialog();
	g_wallMainDlg = this;
	if (m_isWall)
	{
		m_staticTxt1.SetWindowTextW(L"外侧面");
		m_staticTxt2.SetWindowTextW(L"端侧面");
		m_staticTxt3.SetWindowTextW(L"内侧面");
...
void CWallMainRebarDlg::OnEnKillfocusEdit1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CWallMainRebarDlg::OnEnKillfocusEdit2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CWallMainRebarDlg::OnEnKillfocusEdit3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CWallMainRebarDlg::OnEnKillfocusEdit4()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLevelNum;
	m_EditLevel.GetWindowText(strLevelNum);
...
LRESULT CWallMainRebarDlg::OnComboBoxDataChange(WPARAM wParam, LPARAM lParam)
{
	SetListRowData(g_vecRebarData);
	UpdateRebarList();
	return 0;
...
//关联构件
void CWallMainRebarDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_assodlg == NULL)
...
void CWallMainRebarDlg::OnBnClickedHoleCheck()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CWallMainRebarDlg::OnEnKillfocusMholesizeEdit()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CWallMainRebarDlg::OnBnClickedButton2()
{
...
void CWallMainRebarDlg::OnCbnSelchangeCombo1()//配筋方式（板才有）
{
...
void CWallMainRebarDlg::OnBnClickedButton3()
{
	SelectLineDirTool::InstallNewInstance(1, this);
}


void CWallMainRebarDlg::OnBnClickedButtonBreakellipsewall()
{
...
//void CWallMainRebarDlg::OnBnClickedSavedata()
//{ 
//	// TODO: 在此添加控件通知处理程序代码
//	this->Set_m_DlgData();
//}
...
void CWallMainRebarDlg::OnBnClickedRebartemplate()
{
	// TODO: 在此添加控件通知处理程序代码
	// 1、获取当前界面保护层等数据
	CString strpostive;
...
void CWallMainRebarDlg::OnBnClickedUpdatadlg()
{
	// TODO: 在此添加控件通知处理程序代码
	// 1.设置保护层等数据
