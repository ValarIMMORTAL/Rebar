...
*	Module Name:	CAssociatedComponent
*	Project:		三维配筋出图项目
*	Author:			LiuXiang
*	Date:			2021/04/12
	Version:		V1.0
*	Description:	CAssociatedComponent
*	History:
*	1. Date:		2021/04/12
*	Author:			LiuXiang
...
class CAssociatedComponent
{
public:
	CAssociatedComponent(ElementHandle eh):m_NowElm(eh)
	{
		GetAllIntersectDatas();
		GetBothEndIntersectDatas();
	}

	~CAssociatedComponent() {}
...
typedef CAssociatedComponent  CACC;
