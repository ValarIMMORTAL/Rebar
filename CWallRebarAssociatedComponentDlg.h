...
class CWallRebarAssociatedComponentDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CWallRebarAssociatedComponentDlg)

public:
	CWallRebarAssociatedComponentDlg(ElementHandleCR eeh,CWnd* pParent = nullptr);
	virtual ~CWallRebarAssociatedComponentDlg();
...
// 对话框数据
	...
	enum { IDD = IDD_DIALOG_WallRebar_AssociatedComponent };
#endif
...
public:
	...
	CWallRebarAssociatedCtrl m_ListAC;
