...
class CWallRebarDlg;
class CUniteMainRebarDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CUniteMainRebarDlg)

public:
	CUniteMainRebarDlg(CWnd* pParent = nullptr);   // 标准构造函数
	virtual ~CUniteMainRebarDlg();
	CWallRebarAssociatedComponentDlg *m_assodlg;

	C_RebarTemplate							m_RebarTemplate;			//钢筋模板界面
	// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_Combine_Setting_MainRebar };
#endif
