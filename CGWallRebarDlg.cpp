...
IMPLEMENT_DYNAMIC(CGWallRebarDlg, CDialogEx)

CGWallRebarDlg::CGWallRebarDlg(ElementHandleCR eh, CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_Gwall, pParent)
{
	m_ehSel = eh;
...
CGWallRebarDlg::~CGWallRebarDlg()
{
}

void CGWallRebarDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CGWallRebarDlg, CDialogEx)
	ON_BN_CLICKED(IDOK_Gwall, &CGWallRebarDlg::OnBnOKClickedGwall)
	ON_EN_KILLFOCUS(IDC_EDIT_GPositive, &CGWallRebarDlg::OnEnKillfocusEditGpositive)
	ON_EN_KILLFOCUS(IDC_EDIT_GSide, &CGWallRebarDlg::OnEnKillfocusEditGside)
	ON_EN_KILLFOCUS(IDC_EDIT_GReverse, &CGWallRebarDlg::OnEnKillfocusEditGreverse)
	ON_BN_CLICKED(IDC_HOLE_GCHECK, &CGWallRebarDlg::OnBnClickedHoleGcheck)
	ON_EN_KILLFOCUS(IDC_MHOLESIZE_GEDIT, &CGWallRebarDlg::OnEnKillfocusMholesizeGedit)
	ON_EN_KILLFOCUS(IDC_EDIT_GLevel, &CGWallRebarDlg::OnEnKillfocusEditGlevel)
	ON_BN_CLICKED(IDCANCEL_Gwall, &CGWallRebarDlg::OnBnClickedGwall)
	ON_EN_CHANGE(IDC_EDIT1, &CGWallRebarDlg::OnEnChangeEdit1)
	ON_CBN_SELCHANGE(IDC_COMBO3, &CGWallRebarDlg::OnCbnSelchangeCombo3)
	ON_STN_CLICKED(IDC_STATIC_WALLNAME, &CGWallRebarDlg::OnStnClickedStaticWallname)
	ON_CBN_SELCHANGE(IDC_COMBO2, &CGWallRebarDlg::OnCbnSelchangeCombo2)
END_MESSAGE_MAP()


// CGWallRebarDlg 消息处理程序

void CGWallRebarDlg::InitUIData()
{
...
void CGWallRebarDlg::SetListDefaultData()
{
	if (m_vecRebarData.empty())//无数据时根据层数添加默认数据
	{
		for (int i = 0; i < g_wallRebarInfo.concrete.rebarLevelNum; ++i)
		{
			...
			if (0 == i)
				oneRebarData = { i,0,"12",2,200,0,0,0 };
			else if (1 == i)
				oneRebarData = { i,1,"12",2,200,0,0,0 };
			else
			{
				int dir = (i + 1) & 0x01;
				double levelSpace;
				levelSpace = ((i + 1) & 0x01) * 20000.0;
...
void CGWallRebarDlg::UpdateRebarList()
{
...
void CGWallRebarDlg::GetConcreteData(PIT::Concrete& concreteData)
{
...
BOOL CGWallRebarDlg::OnInitDialog()
{
...
void CGWallRebarDlg::OnBnOKClickedGwall()
{
	// TODO: 在此添加控件通知处理程序代码
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnOK();
	...
	EditElementHandle eeh(m_ehSel, m_ehSel.GetModelRef());
	   ...
	   SetListRowData(m_vecRebarData);
		...
		WallRebarAssembly::WallType wallType = WallRebarAssembly::GWALL;

		RebarAssembly* rebaras = PIT::ACCRebarAssembly::GetRebarAssembly(testid, "class GWallRebarAssembly");
		wallRebar = dynamic_cast<GWallRebarAssembly*>(rebaras);
...
void CGWallRebarDlg::OnEnKillfocusEditGpositive()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnEnKillfocusEditGside()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnEnKillfocusEditGreverse()
{
	// TODO: 在此添加控件通知处理程序代码
		// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnBnClickedHoleGcheck()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnEnKillfocusMholesizeGedit()
{
	// TODO: 在此添加控件通知处理程序代码
	// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnEnKillfocusEditGlevel()
{
	// TODO: 在此添加控件通知处理程序代码
		// TODO: 在此添加控件通知处理程序代码
	CString strLevelNum;
...
void CGWallRebarDlg::OnBnClickedGwall()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnCancel();
}
...
void CGWallRebarDlg::OnEnChangeEdit1()
{
...
void CGWallRebarDlg::OnCbnSelchangeCombo3() // 类型
{
	// TODO: 在此添加控件通知处理程序代码
...
void CGWallRebarDlg::OnStnClickedStaticWallname()
{
}


void CGWallRebarDlg::OnCbnSelchangeCombo2()
{
	// TODO: 在此添加控件通知处理程序代码
		// TODO: 在此添加控件通知处理程序代码
	...
	ChangeRebarSizedata(m_WallSetInfo.rebarSize);
	UpdateRebarList();
}
