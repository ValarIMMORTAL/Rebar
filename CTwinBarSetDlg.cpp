...
IMPLEMENT_DYNAMIC(CTwinBarSetDlg, CDialogEx)

CTwinBarSetDlg::CTwinBarSetDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_WallRebar_TwinBarSet, pParent)
{

}

CTwinBarSetDlg::~CTwinBarSetDlg()
{
}

void CTwinBarSetDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTwinBarSetDlg, CDialogEx)
...
// CTwinBarSet 消息处理程序
void CTwinBarSetDlg::InitUIData()
{
...
void CTwinBarSetDlg::SetListDefaultData()
{
...
void CTwinBarSetDlg::UpdateTwinBarsList()
{
...
BOOL CTwinBarSetDlg::OnInitDialog()
{
...
CString CTwinBarSetDlg::GetTwinBarLevelName(int rebarLevel)
{
	CString strValue;
