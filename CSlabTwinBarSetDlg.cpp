...
IMPLEMENT_DYNAMIC(CSlabTwinBarSetDlg, CDialogEx)

CSlabTwinBarSetDlg::CSlabTwinBarSetDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_SlabRebar_TwinBarSet, pParent)
{

}

CSlabTwinBarSetDlg::~CSlabTwinBarSetDlg()
{
}

void CSlabTwinBarSetDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
//	DDX_Control(pDX, IDC_S_CHECK_1, m_CheckIsTwinBars);
//	DDX_Control(pDX, IDC_S_CHECK_2, m_CheckIsStaggered);
	DDX_Control(pDX, IDC_S_LIST_TwinBarSet, m_ListTwinBars);
}


BEGIN_MESSAGE_MAP(CSlabTwinBarSetDlg, CDialogEx)
	//ON_BN_KILLFOCUS(IDC_S_CHECK_1, &CSlabTwinBarSetDlg::OnBnKillfocusCheck1)
	//ON_BN_KILLFOCUS(IDC_S_CHECK_2, &CSlabTwinBarSetDlg::OnBnKillfocusCheck2)
	//ON_BN_CLICKED(IDC_S_CHECK_1, &CSlabTwinBarSetDlg::OnBnClickedCheck1)
	//ON_BN_CLICKED(IDC_S_CHECK_2, &CSlabTwinBarSetDlg::OnBnClickedCheck2)
	//ON_NOTIFY(LVN_ITEMCHANGED, IDC_S_LIST_TwinBarSet, &CSlabTwinBarSetDlg::OnLvnItemchangedListTwinbarset)
END_MESSAGE_MAP()


// CSlabTwinBarSetDlg 消息处理程序
void CSlabTwinBarSetDlg::InitUIData()
{
...
//	m_CheckIsStaggered.SetCheck(false);
	...
	SetListRowData(m_vecTwinBar);

	UpdateTwinBarsList();
}

void CSlabTwinBarSetDlg::SetDefaultRebarData()
{
...
void CSlabTwinBarSetDlg::SetListDefaultData()
{
...
void CSlabTwinBarSetDlg::UpdateTwinBarsList()
{
...
BOOL CSlabTwinBarSetDlg::OnInitDialog()
{
...
CString CSlabTwinBarSetDlg::GetTwinBarLevelName(int rebarLevel)
{
	CString strValue;
...
//void CSlabTwinBarSetDlg::GetTwinBarInfo(TwinBarSet::TwinBarInfo & twInfo)
//{
//	twInfo.isTwinbars = g_twinBarInfo.isTwinbars;
//	twInfo.isStaggered = g_twinBarInfo.isStaggered;
//}
//
//	void CSlabTwinBarSetDlg::OnBnKillfocusCheck1()
//	{
//		// TODO: 在此添加控件通知处理程序代码
...
//
//	//是否交错
//	void CSlabTwinBarSetDlg::OnBnKillfocusCheck2()
//	{
//		// TODO: 在此添加控件通知处理程序代码
...
//
//
//	void CSlabTwinBarSetDlg::OnBnClickedCheck1()
//	{
//		// TODO: 在此添加控件通知处理程序代码
//		g_twinBarInfo.isTwinbars = m_CheckIsTwinBars.GetCheck();
//	}
//
//
//	void CSlabTwinBarSetDlg::OnBnClickedCheck2()
//	{
//		// TODO: 在此添加控件通知处理程序代码
//		g_twinBarInfo.isStaggered = m_CheckIsStaggered.GetCheck();
//	}
//
//void CSlabTwinBarSetDlg::OnLvnItemchangedListTwinbarset(NMHDR *pNMHDR, LRESULT *pResult)
//{
