...
IMPLEMENT_DYNAMIC(CSlabRebarEndType, CDialogEx)

CSlabRebarEndType::CSlabRebarEndType(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_SlabRebar_EndType, pParent)
{

}

CSlabRebarEndType::~CSlabRebarEndType()
{
}

void CSlabRebarEndType::DoDataExchange(CDataExchange* pDX)
{
	DDX_Control(pDX, IDC_S_LIST_EndType, m_ListEndType);
}


void CSlabRebarEndType::InitUIData()
{
	LONG lStyle;
...
void CSlabRebarEndType::SetListDefaultData()
{
...
void CSlabRebarEndType::UpdateEndTypeList()
{
...
BEGIN_MESSAGE_MAP(CSlabRebarEndType, CDialogEx)
//	ON_NOTIFY(LVN_ITEMCHANGED, IDC_S_LIST_EndType, &CSlabRebarEndType::OnLvnItemchangedListEndtype)
END_MESSAGE_MAP()
...
BOOL CSlabRebarEndType::OnInitDialog()
{
...
//
//void CSlabRebarEndType::OnLvnItemchangedListEndtype(NMHDR *pNMHDR, LRESULT *pResult)
//{
